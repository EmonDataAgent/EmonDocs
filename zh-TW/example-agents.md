...
3. **新增資料與技能**：將 OrangeBI 中所需的行政考勤類分析主題資料新增至 Agent 中。選擇並新增『分析主題資料查詢』技能，將其重新命名為『行政考勤資料查詢』。
...
3. **匯入資料與建立範本**：將 OrangeBI 中用於生成報告的儀表板資料新增至 Agent 中。新增『儀表板報告生成』技能，選擇『上傳報告範本』透過 AI 生成範本。
